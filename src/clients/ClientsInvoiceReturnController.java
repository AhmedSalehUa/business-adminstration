 ...
 * @author AHMED
 */
public class ClientsInvoiceReturnController implements Initializable {
    ...
    private void ConfigPanels() throws Exception {
        editePaneTab.setContent(FXMLLoader.load(getClass().getResource("ClientsInvoiceReturnEdits.fxml")));
    }
                ...
                return new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        try {
                            ...
                            autoNum = InvoiceReturn.getAutoNum();
    ...
    private void getData(int id) {
        try {
            ...
            ObservableList<InvoiceReturnDetails> list = FXCollections.observableArrayList();
            list.add(new InvoiceReturnDetails(1, data, "0", "0", "0", "0"));
            ...
            invoiceTable.setOnKeyReleased((event) -> {
                ...
                if (event.getCode() == KeyCode.ENTER) {
                    ...
                    boolean found = false;
                    for (InvoiceReturnDetails item : items) {
                ...
                if (event.getCode() == KeyCode.ENTER && invoiceTable.getSelectionModel().getSelectedItem().getProductsCombo().getSelectionModel().getSelectedIndex() != -1
                    ...
                    setTotal();
                    invoiceTable.getItems().add(new InvoiceReturnDetails(invoiceTable.getItems().size() + 1, data, "0", "0", "0", "0"));
    ...
    private void fillCombo() {
        progress.setVisible(true);
        Service<Void> service = new Service<Void>() {
            ObservableList<InvoiceSell> data;
                ...
                return new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        try {
                            ...
                            data = InvoiceSell.getStockedData();
                        } catch (Exception ex) {
                            AlertDialogs.showErrors(ex);
                        }
                        return null;
